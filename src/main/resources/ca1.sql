...
USE `startcode_test`;
CREATE TABLE startcode_test.CITYINFO LIKE startcode.CITYINFO;
CREATE TABLE startcode_test.ADDRESS LIKE startcode.ADDRESS;
CREATE TABLE startcode_test.PERSON LIKE startcode.PERSON;
CREATE TABLE startcode_test.HOBBY LIKE startcode.HOBBY;
CREATE TABLE startcode_test.PHONE LIKE startcode.PHONE;
CREATE TABLE startcode_test.PERSON_HOBBY LIKE startcode.PERSON_HOBBY;
